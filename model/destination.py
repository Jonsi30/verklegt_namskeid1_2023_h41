class Destination:
    ...
    def __str__(self):
        return f"destination: {self.destination}, distance from Iceland: {self.distance_from_ice}, flight time: {self.flight_time}, emergency contact: {self.emergency_contact},{self.emergency_contact_phone_nr}"